...
def parse_args():
    ...
    parser.add_argument('--env-id', type=str, default='cgmGrid')
    parser.add_argument('--critic-type', type=int, default=1)
    parser.add_argument('--max-var', type=float, default=10.0)
    parser.add_argument('--penalty-weight', type=float, default=1.0)
    parser.add_argument('--satisfied-percentage', type=float, default=0.9)
    boolean_flag(parser, 'critic-norm', default=False)
    boolean_flag(parser, 'vf-normalization', default=False)
    parser.add_argument('--critic-training-type', type=int, default=2)
    boolean_flag(parser, 'render-eval', default=False)
    boolean_flag(parser, 'relu-output', default=True)
    parser.add_argument('--critic-activation', type=str, default=None)
    boolean_flag(parser,'layer-norm', default=False)
    boolean_flag(parser,'batch-norm', default=False)
    boolean_flag(parser, 'render', default=False)
    parser.add_argument('--num-cpu', type=int, default=1)
    #For patrolling domain
    parser.add_argument('--grid-size', type=int, default=10)
    parser.add_argument('--victim-num', type=int, default=1)
    parser.add_argument('--evader-num', type=int, default=30)
    parser.add_argument('--population-size', type=int, default=20)
    parser.add_argument('--shift', type=int, default=1)
    #===============
    #loading params
    parser.add_argument('--params-epoch', type=int, default=0)
    parser.add_argument('--reward-scaler', type=float, default=1.0)
    boolean_flag(parser, 'normalize-returns', default=False)
    boolean_flag(parser, 'normalize-observations', default=False)#True
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--critic-l2-reg', type=float, default=0.0)#1e-2
    parser.add_argument('--batch-size', type=int, default=100)  # per MPI worker
    parser.add_argument('--actor-lr', type=float, default=1e-4)
    parser.add_argument('--ent-coef', type=float, default=0.0)#1e-2
    parser.add_argument('--critic-lr', type=float, default=1e-3)
    parser.add_argument('--hidden-unit-num', type=int, default=0)
    boolean_flag(parser, 'popart', default=False)
    parser.add_argument('--gamma', type=float, default=0.99)
    parser.add_argument('--lambda', type=float, default=0.8)
    parser.add_argument('--reward-scale', type=float, default=1.)
    parser.add_argument('--clip-norm', type=float, default=None)
    parser.add_argument('--nb-epochs', type=int, default=80e6)  # with default settings, perform 1M steps total
    parser.add_argument('--nb-epoch-cycles', type=int, default=20)
    parser.add_argument('--nb-train-steps', type=int, default=50)  # per epoch cycle and MPI worker
    parser.add_argument('--nb-eval-steps', type=int, default=100)  # per epoch cycle and MPI worker
    parser.add_argument('--nb-rollout-steps', type=int, default=100)  # per epoch cycle and MPI worker
    parser.add_argument('--log-interval', type=int, default=100)
    parser.add_argument('--noise-type', type=str, default='none')  #adaptive-param_0.2 choices are adaptive-param_xx, ou_xx, normal_xx, none
    parser.add_argument('--logdir', type=str, default=None)
    boolean_flag(parser, 'gym-monitor', default=False)
    boolean_flag(parser, 'evaluation', default=False)
    boolean_flag(parser, 'bind-to-core', default=False)
    parser.add_argument('--replay-memory-size', type=int, default=100)#1e6
...
class SimpleMonitor(gym.Wrapper):
    ...
    def _reset(self):
        ...
        return obs, stateCount

    def _step(self, act_prob):
        obs, action, rew, done, info = self.env.step(act_prob)
